  ...
  return (
    <section className={style.bg}>
      <div className="relative px-5 py-14 grid tablet:px-8 tablet:py-16 tablet:auto-cols-auto tablet:auto-rows-auto tablet:gap-x-5 desktop:p-[104px]">
        ...
        <div className="desktop:mb-8 desktop:row-start-1 desktop:col-end-5 tablet:col-start-3 tablet:mt-0 justify-self-end mt-6">
        ...
        <div className="desktop:mt-0 desktop:justify-self-start desktop:ml-[122px] tablet:mt-3 justify-self-end mt-9">
        ...
        <div className="tablet:mt-0 tablet:col-start-1 tablet:row-span-2 mt-9 mr-[99px] tablet:mr-0 grid gap-4">
          ...
          <div className="desktop:grid-flow-col desktop:gap-6 grid gap-2">
            <p className="advantages desktop:w-[290px]">Exciting challenges</p>
            <p className="description_carrer desktop:w-[285px]">
        ...
        <div className=" desktop:col-start-3 desktop:col-end-5 relative tablet:col-start-2 tablet:row-span-2 tablet:col-span-2 tablet:block hidden  ">
          <Form />
        </div>
      </div>
    </section>
