  ...
  return (
    <section id="carrer" className={style.bg}>
      <div className="relative px-5 py-14 grid tablet:px-8 tablet:py-16 tablet:auto-cols-auto tablet:auto-rows-auto tablet:gap-x-5 desktop:p-[104px]">
        ...
        <div className="desktop:justify-self-end relative desktop:row-start-2 desktop:row-span-3 tablet:col-start-2 tablet:row-span-2 tablet:col-span-2 tablet:block hidden  ">
          <Form />
        </div>
      </div>
    </section>
