  ...
  return (
    <div className={style.bg}>
      <div className={style.overlay}>
        ...
        <Header />
        <div className=" mx-5 pb-14 grid gap-6 pt-[25px] tablet:mx-8 tablet:pt-[66px] tablet:grid-cols-3 tablet:grid-rows-2 tablet:gap-0 desktop:mx-[80px] desktop:p-[24px] ">
